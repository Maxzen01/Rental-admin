...
<div class="navbar">
    <div class="logo">
        <a href="http://localhost/Rental/admin/admin_home.php" style="text-decoration: none; color: inherit;">LOGO</a>
    </div>
</div>
  ...
  <!-- Add Button -->
  <button class="add-button" onclick="location.href='add-product.php'">+</button>
  ...
  <div class="footer">
    <div class="services">
        <div>
            <h3>Services</h3>
            <p><a href="furniture.php" style="text-decoration: none; color: inherit;">Furniture Rentals</a></p>
            <p><a href="electronic.php" style="text-decoration: none; color: inherit;">Electronics Rentals</a></p>
            <p><a href="vehicle.php" style="text-decoration: none; color: inherit;">Vehicle Rentals</a></p>
            <p><a href="sports.php" style="text-decoration: none; color: inherit;">Sports Equipment Rentals</a></p>
            <p><a href="fitness.php" style="text-decoration: none; color: inherit;">Fitness Rentals</a></p>
        </div>
        <div>
            <h3>Contact</h3>
